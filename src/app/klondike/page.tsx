...
const cardPositionSetup: CardPosition[] = [
    { boardPosition: 7, stackPosition: 0 },
    ...
    { boardPosition: 8, stackPosition: 1 },
    ...
    { boardPosition: 9, stackPosition: 2 },
...
const Klondike = () => {
    ...
    const handleOnDragEnd = (result: DropResult) => {
        ...
        if (result.destination) {
            ...
            const newCards = items.map((c) => {
                if (
                    (c.boardPosition === Number(result.source.droppableId) || c.boardPosition === 14) &&
